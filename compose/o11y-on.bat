...
rem      Grafana -- the "o11y" compose profile), and
rem   2. recreate the app services with tracing ON (ESQ_TRACING_ENABLED=true).
...
rem ===========================================================================
set ESQ_TRACING_ENABLED=true

echo --- bringing up the o11y viewing stack (loki/alloy/tempo/otel-collector/grafana)...
docker compose --profile o11y up -d loki alloy tempo otel-collector grafana || exit /b 1

echo --- recreating the app services with tracing ON...
