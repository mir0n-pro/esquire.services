...
cd /d "%~dp0"
rem ===========================================================================
rem o11y-full.bat -- the FULL arm: the whole viewing stack, and the services armed to feed it.
rem
rem This lab keeps THREE arms and no more:
rem   o11y-debug.bat   no o11y, all logs local at DEBUG   -- developing
rem   o11y-off.bat     no o11y, normal log levels         -- the everyday stack
rem   o11y-full.bat    the whole viewing stack, armed     -- this one
rem The classic stack also carries log-only isolation arms; they exist to measure the LOGGING share of the
...
rem the everyday stack default is tracing OFF.
rem
...
echo.
echo o11y FULL (docker AWS lab). Grafana: http://localhost:3009  (admin/admin)
echo   verify the pillars : o11y-verify.bat      (one FAIL is expected -- see its header)
echo   verify AWS itself  : aws-spec.bat
endlocal
