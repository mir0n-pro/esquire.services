...
public record KeepDataSourceParams(String vendor, String url, String username, String password, Hikari hikari,
                                   Boolean shared) {
     ...
     *  dedicated pool from {@code url}/{@code hikari}. When shared, the dialect comes from the service profile. */
