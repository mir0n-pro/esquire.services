...
class PacManServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new PacManService(entityRepository, transactionTemplate, em, broadcastPublisher, acctTrxRepo, Mockito.mock(pro.mir0n.esquire.messaging.xrod.IXRod.class));
