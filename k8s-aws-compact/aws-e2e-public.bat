...
rem on the SUPER-COMPACT cluster (esquire-aws-compact).
rem
...
rem   - ingress + certificate live                (cluster\ingress.yaml, cluster-issuer.yaml)
...
set WANT=arn:aws:eks:%AWS_REGION%:%ACCT%:cluster/esquire-aws-compact
