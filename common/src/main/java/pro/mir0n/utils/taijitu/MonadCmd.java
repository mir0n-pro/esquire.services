 ...
 *
 * Commands are issued ONLY via {@code AMonadY.submit(commandId)} using these constants, so the
 ...
 *   CHECKSUM -- content hash of the cache (stub until the Yin / night-watch lands).
 */
