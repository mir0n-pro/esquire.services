 ...
 * 06/15/2026 mir0n  ctor opens the rod via rods.producer(BUS_KEY_ENTITY, Role.BROADCAST); publish() builds a
 *                   RodEvent (msg-type UE) and calls rod.transmit. No JmsTemplate / ObjectMapper / service-id
 *                   / ctrl-id / FIX-JSON property assembly here; envelope fields come from the catalog leg.
 */
 ...
 * {@link RodEvent} (msg-type UE) and sends it out the leg. Publish only after commit (post-commit).
 */
@Slf4j
@Component
